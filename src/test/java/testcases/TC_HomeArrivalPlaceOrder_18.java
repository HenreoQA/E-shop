...
public class TC_HomeArrivalPlaceOrder_18 extends BaseClass
{
	@Test
	public void verify_place_order_button() throws InterruptedException 
	{
		logger.info("**** Starting TC_HomeArrivalPlaceOrder_18  *****");
		...
		catch(Exception e)
		{
			logger.error("test failure..");
		       ...
		       logger.debug("Application debug logs ends...");
				logger.info("**** Finished TC_HomeArrivalPlaceOrder_18  ****");
	    }
