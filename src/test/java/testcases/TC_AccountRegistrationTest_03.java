...
public class TC_AccountRegistrationTest_03 extends BaseClass
{
	@Test
	public void verify_account_reg_with_empty_email_id() 
	{
		  logger.info("**** starting TC_AccountRegistrationTest_03  *****");
		  ...
		  try 
		{
	     ...
	     Reg.clickregbtn();
	      ...
	      catch(Exception e)
		  {
		    ...
		    logger.info("**** finished TC_AccountRegistrationTest_03  *****");
