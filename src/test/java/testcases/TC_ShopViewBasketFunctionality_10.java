...
public class TC_ShopViewBasketFunctionality_10 extends BaseClass
{
	@Test
	public void verify_view_basket_functionality() throws InterruptedException 
	{
		logger.info("**** Starting TC_ShopViewBasketFunctionality_10  *****");
	    ...
	    logger.info("Clicking on view basket link...");
	    
	    sp.clickviewbasketlink();
		...
		catch(Exception e)
		{
			logger.error("test failure..");
		       ...
		       logger.debug("Application debug logs ends...");
				logger.info("**** Finished TC_ShopViewBasketFunctionality_10  ****");
