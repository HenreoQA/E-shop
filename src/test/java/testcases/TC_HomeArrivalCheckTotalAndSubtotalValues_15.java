...
public class TC_HomeArrivalCheckTotalAndSubtotalValues_15 extends BaseClass
{
	@Test
	public void verify_total_and_subtotal_values() throws InterruptedException 
	{
		logger.info("**** Starting TC_HomeArrivalCheckTotalAndSubtotalValues_15  *****");
		...
		catch(Exception e)
		{
			logger.error("test failure..");
		       ...
		       logger.debug("Application debug logs ends...");
				logger.info("**** Finished TC_HomeArrivalCheckTotalAndSubtotalValues_15  ****");
